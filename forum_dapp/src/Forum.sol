...
contract Forum {
   ...
   function createPost(string memory _title, string memory _description, bool _spoil) public returns (uint256) {
        ...
        returns (uint256)
    {
        ...
        userComments[msg.sender].push(commentId); // Fixed userPolls to userComments
        return commentId;
    }
    ...
    function upVoteComment(uint256 _commentId) public {
        require(_commentId < commentIdIncrement, "Comment does not exist!"); // Corrected error message
